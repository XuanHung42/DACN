...
namespace ManageProject.Data.Seeders
{
    public class DataSeeder : IDataSeeder
    {
        ...
        public void Initialize()
        {
            ...
            var posts = AddPosts(users, project, departments, topics);
        ...
        private IList<Project> AddProjects(IList<User> users, IList<Process> processes, IList<Topic> topics)
        {
            var projects = new List<Project>()
            {
				   ...
				   new()
				{
					...
					CostProject= "6000000",
					UserNumber=3,
					Users= new List < User >() { users[0], users[1], users[2] },
					Register = false,
					Process= processes[0],
					Topic= topics[0],
					StartDate= DateTime.Now,
        ...
        private IList<Post> AddPosts(IList<User> users, IList<Project> projects, IList<Department> department, IList<Topic> topics)
        {
